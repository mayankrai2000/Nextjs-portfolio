...
const about = {
 ...
 description:
  "Specializing in React, Next.js, Vue.js, and NestJS, I build modern and performant web applications with modern frameworks, focusing on scalability and user experience",
